...
There are plenty of sites to generate schema or to write schema yourself.

= Can I overwrite other schema? =

No, this plugin just adds an oppertunity to insert your own JSON-ld schema. To remove other schema please use the plugin [Remove Schema](https://wordpress.org/plugins/remove-schema/ "Remove Schema WordPress plugin")
